...
# 
# Among all the models studied, Random Forest (0.18 RMSE), Decision Tree (0.24 RMSE) and Neural Nets (0.7 RMSE) seem to work the best.
# 
...
# 
# The approach starts with the basic model with a high RMSE and ends with the Random Forest (0.18 RMSE) model which works best for the dataset
